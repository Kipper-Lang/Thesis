...
\lstdefinelanguage{Kipper}{
	morekeywords={typeof, new, true, false, catch, def, return, null, switch, var, if, in, while, do, else, case, break, void, module, \$, export, for, this, class, interface, enum, extends, implements, constructor, var, const, super, null, undefined, num, str, bool, obj, type, any, Array, Func},
	keywordstyle=\color{blue}\bfseries,
	morekeywords=[2]{class, export, boolean, throw, implements, import, this},
	keywordstyle=[2]\color{darkgray}\bfseries,
	sensitive=true,
