...
\lstdefinelanguage{TypeScript}{
	morekeywords={typeof, new, true, false, catch, function, return, null, switch, var, if, in, while, do, else, case, break, void, module, \$, export, for, this, class, interface, enum, extends, implements, constructor, var, let, const, super, null, undefined, number, string, boolean, object, any, bigint, symbol, async},
	keywordstyle=\color{blue}\bfseries,
	morekeywords=[2]{class, export, boolean, throw, implements, import, this},
	keywordstyle=[2]\color{darkgray}\bfseries,
	sensitive=true,
...
\lstdefinelanguage{Kipper}{
	morekeywords={typeof, new, true, false, catch, def, return, null, switch, var, if, in, while, do, else, case, break, void, module, \$, export, for, this, class, interface, enum, extends, implements, constructor, var, const, super, null, undefined, num, str, bool, obj, type, any, Array, Func, T, R, cast, force, try, as},
	keywordstyle=\color{blue}\bfseries,
	morekeywords=[2]{class, export, boolean, throw, implements, import, this},
	keywordstyle=[2]\color{darkgray}\bfseries,
	sensitive=true,
