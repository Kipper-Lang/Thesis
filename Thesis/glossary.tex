...
\newglossaryentry{basic-multilingual-plane}{
	name={Basic Multilingual Plane},
	description={The Basic Multilingual Plane (BMP) is the first plane of the Unicode character set, also known as Plane 0. It consists of 65,536 (or \(2^{16}\)) code points, ranging from U+0000 to U+FFFF. The BMP includes characters used in most modern languages, as well as special symbols, punctuation marks and diacritical signs.}
}
